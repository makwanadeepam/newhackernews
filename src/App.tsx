...
function App() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
            ...
            <main className="w-full max-w-5xl mx-auto px-3 sm:px-4 py-6">
                {viewingComments && selectedStory ? (
                    ...
                    <div
                        className="bg-red-100 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-4 py-3 rounded relative"
                        role="alert"
                    >
                    ...
                    <>
                        ...
                        <div className="mt-8 flex justify-between items-center">
                            <button
                                ...
                                disabled={page === 0}
                                className={`px-3 sm:px-4 py-2 rounded-md flex items-center ${
                                    page === 0
            ...
            <footer className="w-full bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 py-4 mt-8">
